...
export const AuthErrorCodes = {
  ...
  USER_ALREADY_EXIST: new ErrorCode(
    'USER_ALREADY_EXIST',
    409,
    '이미 존재하는 사용자입니다',
  ),
  PASSWORD_WRONG: new ErrorCode(
    'PASSWORD_WRONG',
    401,
    '비밀번호가 올바르지 않습니다',
  ),
  OVER_RETRY: new ErrorCode(
    'OVER_RETRY',
    429,
  ...
  EMAIL_ALREADY_IN_USE: new ErrorCode(
  ...
  INVALID_NAME_FORMAT: new ErrorCode(
    'INVALID_NAME_FORMAT',
    400,
    '유효하지 않은 이름 형식입니다',
  ),
  TERMS_NOT_AGREED: new ErrorCode(
    'TERMS_NOT_AGREED',
    400,
    '서비스 이용 약관에 동의해야 합니다',
  ),
